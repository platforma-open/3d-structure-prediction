...
export type _3dStructurePredictionBlockContract = BlockContract;
export type _3dStructurePredictionBlockOutputs  = BlockOutputs;
export type _3dStructurePredictionBlockData     = BlockData;
export const _3dStructurePredictionBlockPointer = BlockPointer;
